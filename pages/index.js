...
export default function Home() {
    return ( <
        ...
        content = "Jochen Bieler Fotografie - Dein Fotograf in Berlin und Brandenburg" / >
        <
        link rel = "icon"
        href = "/favicon.ico" / >
        <
        link href = "https://fonts.googleapis.com/css2?family=Montserrat&weight=400"
        rel = "stylesheet" / >
        <
        /Head>
        ...
        main >
        <
        TitledComponent title = "Über mich"
        anchorId = "ueber-mich" >
        <
        Container >
        <
        ...
        className = "mb-4" > Hi, mein Name ist Jochen.Ich bin verheiratet, Vater von 2 Kindern und lebe im der Nähe von Berlin.Ich fotografiere gern alles um mich herum und das aus Leidenschaft.Ich begleite Hochzeiten, fotografiere Babybäuche und führe Babyshootings durch. < /Col> < /
        Row > <
        /Container>

        <
        /TitledComponent> <
        TitledComponent title = "Angebot"
        anchorId = "angebot" >
        <
        Offer / >
        <
        /TitledComponent> <
        TitledComponent title = "Portfolio"
        anchorId = "portfolio" >
        <
        ...
        className = "mb-4" > Schreiben Sie mir Ihre Vorstellungen und Wünsche.Ich werde mich dann umgehend mit einem auf Sie zugeschnittenen Angebot bei Ihnen melden. < /Col> < /
        Row > <
        /Container> <
        Contact / >
        <
